...
from environment import Craft, CraftState, ReachFacts, ReachDisjunctiveFacts
...
def qrm_test(out_file: str, alpha: float = 0.95, gamma: float = 1.0, epsilon: float = 0.1, name: str =''):
    with open(out_file, "w") as csvfile:
        ...
        reward = ReachDisjunctiveFacts(env, GOAL)
...
def crm_test(out_file: str, alpha: float = 1.0, gamma: float = 1.0, epsilon: float = 0.1, name: str =''):
    with open(out_file, "w") as csvfile:
        ...
        agentCRM = RMAgent(env, policyCRM, reward, rng, "CRM-bridge")
...
if __name__=="__main__":
    for i in range(0, 10):
        map_fn = './src/tests/craft/gold-gem-maps/map_{}.map'.format(i)

        GOAL = [OBJECTS["gold"], OBJECTS["gem"]]

        qrm_test("./plots/gold-gem-results/mprm-gold-gem{}.csv".format(i), alpha=0.95, name='gold_gem_MPRM')
        qrm_test("./plots/gold-gem-results/seq0-gold-gem{}.csv".format(i), alpha=0.95, name='SEQ0')
        qrm_test("./plots/gold-gem-results/seq1-gold-gem{}.csv".format(i), alpha=0.95, name='SEQ1')
        qrm_test("./plots/gold-gem-results/seq2-gold-gem{}.csv".format(i), alpha=0.95, name='SEQ2')
        qrm_test("./plots/gold-gem-results/seq3-gold-gem{}.csv".format(i), alpha=0.95, name='SEQ3')
        qrm_test("./plots/gold-gem-results/seq4-gold-gem{}.csv".format(i), alpha=0.95, name='SEQ4')
        qrm_test("./plots/gold-gem-results/seq5-gold-gem{}.csv".format(i), alpha=0.95, name='SEQ5')
        qrm_test("./plots/gold-gem-results/seq6-gold-gem{}.csv".format(i), alpha=0.95, name='SEQ6')
        qrm_test("./plots/gold-gem-results/pop0-gold-gem{}.csv".format(i), alpha=0.95, name='POP0')
        qrm_test("./plots/gold-gem-results/pop1-gold-gem{}.csv".format(i), alpha=0.95, name='POP1')
        qrm_test("./plots/gold-gem-results/pop2-gold-gem{}.csv".format(i), alpha=0.95, name='POP2')

        #crm_test("./plots/gold-gem-results/crm-gold-gem{}.csv".format(i), name='gold_gem_MPRM')